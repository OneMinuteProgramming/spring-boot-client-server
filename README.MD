...
[![YouTube Video](https://img.youtube.com/vi/zbeqhlBk7ao/0.jpg)](https://www.youtube.com/watch?v=zbeqhlBk7ao)
...
## Run the application
```shell
java -jar ./build/libs/spring-boot-client-server-0.0.1-SNAPSHOT.jar
```
